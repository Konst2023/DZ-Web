<?php
# https://paiza.io/projects/2J3-8fnRXOolL_n7rMI2kw?language=php
...
$experience = [
  ...
  [
    'job' => 'Разработчик Frontend',
    'dates' => 'Mar-2018 - May-2021',   
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $first['job']?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $first['dates']?><span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p><?php echo $first['info']?></p>
            <hr>
          </div>
          <!-- Начало цикла -->
          ...
          <div class="w3-container">
            ...
            <p><?php echo $experience[$i]['info']?></p>
            <hr>
          </div>
          <?php endfor;?>
          <!-- Конец цикла -->
